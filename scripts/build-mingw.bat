...
gcc86 -m32 -DBUILD_STATIC -c ..\..\..\..\src\*.c
ar rvs libcliac.a *.o
del "*.o" /s /q

echo Build x64 static library ...
cd x64
gcc64 -m64 -DBUILD_STATIC -c ..\..\..\..\..\src\*.c
ar64 rvs libcliac.a *.o
del "*.o" /s /q

echo Copy include directory ...
cd ..\..\..\..\..\scripts
xcopy /e /i /y ..\include ..\builds\libs\shared\mingw\include
xcopy /e /i /y ..\include ..\builds\libs\static\mingw\include